...
namespace FarAway2._0.Properties {
    ...
    internal class Resources {
        ...
        /// <summary>
        ///   Looks up a localized string similar to Вы имеете доступ (просмотр, редактирование, а также добавление новых данных) ко всей информацией, связанной с пользователями, их арендами, а также дополнительными услугами. Вам также доступны основные функции формирования отчётов и анализа, специфически связанные с работой с клиентами..
        /// </summary>
